...
Namespace SummarySample
    ...
    Public Class CustomersViewModel
        ...
        Public Sub New()
            ...
            TotalSummary = New ObservableCollection(Of Summary)() From {New Summary(SummaryItemType.Count, NameOf(Customer.Name)), New Summary(SummaryItemType.Max, NameOf(Customer.Visits))}
